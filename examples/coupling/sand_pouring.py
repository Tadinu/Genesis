...
def main():
    ...
    cheezit_box = scene.add_entity(
        morph=gs.morphs.Mesh(
            ...
            pos=cheezit_box_poses[0][:3],  # (0.5, 0.1, 1.6),
            # scale=(0.01, 0.03, 0.03),
            scale=0.01,
            # euler=(0, 0, 0),
            quat=cheezit_box_poses[0][3:],
    ...
    # NOTE: MPM.sand current has a bug, which only supports batched env
    ...
    # Save video
    cam.stop_recording(save_to_filename='grain_pouring.mp4', fps=20)
