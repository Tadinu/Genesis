...
class FrameTask(Task):
    ...
    def set_target_from_configuration(self, configuration: Configuration) -> None:
        ...
        """
        self.set_target(
            configuration.get_transform_frame_to_world(self.frame)
        )
    ...
    def compute_jacobian(self, configuration: Configuration) -> np.ndarray:
        ...
        jac = configuration.get_frame_jacobian(self.entity, self.frame)

        transform_frame_to_world = configuration.get_transform_frame_to_world(self.frame)
